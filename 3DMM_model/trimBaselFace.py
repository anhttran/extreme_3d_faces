...
if not with_forehead:
	...
	faces_fill = mod_struct.faces_fill
else:
	...
	faces_fill = mod_struct.faces_wForehead

## Warning: Water-tight connectivity (faces_fill) and symmetry vertex pair index (pair) is not supported in with_forehead mode  
